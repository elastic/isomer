---
title: Pack contract
description: src/render/context.ts declares the pack's PackTypes once, and src/primitives/define.ts binds the SDK's definePrimitive to it so each primitive names only...
url: https://docs-v3-preview.elastic.dev/pr-preview/pr-1/slides/contract
---
