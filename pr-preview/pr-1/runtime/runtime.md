---
title: Runtime
description: A runtime is the assembled machine. A pack is a vocabulary and a frame is a document; the runtime is what turns them into something a host can call —...
url: https://docs-v3-preview.elastic.dev/pr-preview/pr-1/runtime/runtime
---

# Runtime
A runtime is the assembled machine. A [pack](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/runtime/packs) is a vocabulary and a [frame](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/runtime/frame) is a document; the runtime is what turns them into something a host can call — one dispatcher, one validator, one parser, a view registry, and one [surface](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/runtime/surfaces) per output format, all agreeing on the same inventory.
```ts
...
[Packs](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/runtime/packs) · [Frame](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/runtime/frame) · [Surfaces](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/runtime/surfaces) · [API reference](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/runtime/api)