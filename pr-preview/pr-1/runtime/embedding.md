---
title: Embedding a composition in a host page
description: Rendering a composition to HTML is the html surface. Getting that HTML onto a page a host already controls is a separate problem, and this page covers...
url: https://docs-v3-preview.elastic.dev/pr-preview/pr-1/runtime/embedding
---

# Embedding a composition in a host page
Rendering a composition to HTML is [the `html` surface](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/runtime/surfaces). Getting that HTML onto a page a host already controls is a separate problem, and this page covers the one part of it Isomer has an opinion about: **CSS isolation**.
