---
title: Rendering
description: The SDK owns the output shapes: what a whole composition looks like as text, markdown, Slack blocks, and HTML. Dispatch gets a single node to its renderer;...
url: https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/rendering
---

# Rendering
The SDK owns the output shapes: what a whole composition looks like as text, markdown, Slack blocks, and HTML. [Dispatch](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/dispatch) gets a single node to its renderer; this layer wraps the body in whatever the format calls an envelope.
...
The wrapper hook is named for the wrapper rather than the SVG frame. The document an image is drawn inside is a [Frame](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/frame).
...
[Dispatch](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/dispatch) · [Frame](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/frame)