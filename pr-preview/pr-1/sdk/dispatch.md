---
title: Dispatch
description: The dispatcher is how a node reaches its renderer. It is built once from a flat list of definitions, keyed on type and nothing else, and every surface...
url: https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/dispatch
---
...
[Rendering](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/rendering) for the envelopes wrapped around these calls · [Primitives](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/primitives) for what the renderers are · [Frame](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/frame) for the `svg` walk