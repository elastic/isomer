---
title: Composition and validation
description: A Composition is the resolved JSON document that travels: a title, an optional subtitle and theme, an optional version, and a body of at least one node...
url: https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/composition
---
...
[Primitives](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/primitives) for `schema` versus `schemaFor` · [Dispatch](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/dispatch) · [URL trust](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/url-trust) for the refinements on URL-bearing fields