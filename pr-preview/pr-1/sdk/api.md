---
title: API reference
description: What each entry point exports, and which ones cost you a dependency. Types: PrimitiveDefinition, AnyPrimitiveDefinition, PrimitiveNode, PrimitiveSchema...
url: https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/api
---
...
`assetUrl`, `navigationHref`, `sanitizeAssetUrl`, `sanitizeNavigationHref`, `ASSET_URL_MESSAGE`, `NAVIGATION_HREF_MESSAGE`, `BLOCKED_HREF` — see [URL trust](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/sdk/url-trust).
