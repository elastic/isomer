...
url: https://docs-v3-preview.elastic.dev/pr-preview/pr-1/slides
---
...
| Page                                                                                           | What it covers                                                       |
|------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|
| [Authoring a primitive](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/slides/primitives) | Colocated renderers and why the split exists                         |
| [Pack contract](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/slides/contract)           | `definePrimitive`, `themeBound`, the surface declaration             |
| [Document](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/slides/document)                | Geometry, `validateBody`, `wrap`                                     |
| [Theme](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/slides/theme)                      | The one-field bound and how palette selection works                  |
| [Styling](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/slides/styling)                  | Distillate collection, the pack's own adapter, and the React surface |
| [Worked example](https://docs-v3-preview.elastic.dev/pr-preview/pr-1/slides/example)           | The five example compositions, their artifacts, and how to get a PNG |
